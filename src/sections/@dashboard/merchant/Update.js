...
function Create() {
  ...
  const loading = useSelector(state => state.UpdateMerchant.loading)
  const success = useSelector(state => state.UpdateMerchant.success)
  ...
  const formik = useFormik({
    ...
    onSubmit: (values) => {
      dispatch(UpdateMerchant(id, values))
      console.log(values)
